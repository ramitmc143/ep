...
//       if (json.status === 1 && json.latest_Notification && json.latest_Notification.length > 0) {
...
//     // Removed: setPrivacyVisible(false);
//   };
...
//   const handleContinue = async () => {
//     if (!isChecked) return; // Just a safeguard, button disabled if not checked
  
//     await AsyncStorage.setItem('isFirstLaunch', 'false'); // Save that user agreed
//     navigation.replace('MainTabs'); // Navigate to main tabs
//   };
...
//             <Icon
//               name={termsVisible ? 'expand-less' : 'expand-more'}
//               size={24}
//             />
//           </TouchableOpacity>
//           {termsVisible && (
...
//             <Icon
//               name={privacyVisible ? 'expand-less' : 'expand-more'}
//               size={24}
//             />
//           </TouchableOpacity>
//           {privacyVisible && (
